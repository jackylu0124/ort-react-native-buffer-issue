...
export declare namespace Binding {
  ...
  interface InferenceSession {
    // loadModel(modelPath: string, options: SessionOptions): Promise<ModelLoadInfoType>;  // JL commented this out
    loadModel(bufferEncoding: string, options: SessionOptions): Promise<ModelLoadInfoType>; // JL: only changed variable name in order to be consistent with the function's features
